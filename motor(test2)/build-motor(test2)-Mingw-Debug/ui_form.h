...
public:
    ...
    void setupUi(QMainWindow *form)
    {
        ...
        stateNumber->setProperty("value", QVariant(9));
        stateNumber->setProperty("intValue", QVariant(9));
        ...
        errorNumber->setProperty("value", QVariant(8));
        errorNumber->setProperty("intValue", QVariant(8));
        ...
        locationNumber->setProperty("value", QVariant(89));
        locationNumber->setProperty("intValue", QVariant(89));
        ...
        velNumber->setProperty("value", QVariant(1167));
        velNumber->setProperty("intValue", QVariant(1167));
        ...
        testButton_2->setGeometry(QRect(150, 580, 93, 28));
    ...
    void retranslateUi(QMainWindow *form)
    {
        ...
        testButton_2->setText(QApplication::translate("form", "PushButton", Q_NULLPTR));
