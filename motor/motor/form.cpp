...
//建立通信
void form::on_set_XNet_triggered()
{
...
void form::on_dian_start_pressed()
{
    ...
    Write_Bool(XNet_M,1,1,true);//将点动模式运行置true
